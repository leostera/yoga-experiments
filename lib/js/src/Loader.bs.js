...
function fullScreenNode() {
  return Yoga$AsdfFlows.Node[/* create */0](/* record */[
...
function textNode(node, text) {
  return React.createElement("div", {
              style: Yoga$AsdfFlows.project(node, {
                    color: "#eaeaea"
                  })
            }, text);
}
...
function make(width, height, phase, children) {
  return /* record */[
          ...
          /* render */(function (self) {
              ...
              return React.createElement("div", {
                          style: Yoga$AsdfFlows.project(self[/* state */1][/* node */0], {
                                backgroundColor: "#403E48"
                              })
                        }, tmp);
            }),
          /* initialState */(function () {
              var text_node = Yoga$AsdfFlows.Node[/* create */0](/* record */[
                    /* width */70,
                    /* height */20,
                    /* justify_content : Center */1,
                    /* flex_direction : Column */0,
              ...
              return /* record */[
                      /* node */Yoga$AsdfFlows.Node[/* calculateLayout */2](/* record */[
                            /* width */width,
                            /* height */height,
                            /* direction : Left_to_right */1
                          ], Yoga$AsdfFlows.Node[/* insertChild */1](text_node, 0, fullScreenNode(/* () */0))),
                      /* text_node */text_node
                    ];
            }),
